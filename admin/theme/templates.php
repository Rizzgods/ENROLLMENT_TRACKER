   ...
   <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top  " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <img src="<?php echo web_root; ?>img/bcp_logo.png" height="23">
                Bestlink College of the Philippines</a>
            </div>
            <!-- /.navbar-header -->
...
?> 
   ...
   <h4 class="text-center" style="color: white; font-size: 20px;">Admission Department</h4><br>
                        ...
                        <?php if ($_SESSION['ACCOUNT_TYPE']=='Head Administrator') {
                            # code...
                        ?>
                          <li>
