                    ...
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                       <select class="form-control input-sm" name="U_ROLE" id="U_ROLE">
                          <option value="Head Administrator"  <?php echo ($singleuser->ACCOUNT_TYPE=='Head Administrator') ? 'selected="true"': '' ; ?>> Head Administrator</option>
                          <!-- <option value="Staff" <?php echo ($singleuser->ACCOUNT_TYPE=='Staff') ? 'selected="true"': '' ; ?>>Staff</option>  -->
                          <!-- <option value="Customer">Customer</option> -->
                              <option value="Staff" <?php echo ($singleuser->ACCOUNT_TYPE=='Staff') ? 'selected="true"': '' ; ?>>Admin Staff</option>
