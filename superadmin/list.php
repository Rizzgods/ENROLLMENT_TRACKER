<body class="bg-gray-100 p-4 h-screen flex justify-center">
    ...
    <div class="flex w-full max-w-7xl mx-auto space-x-4">
        ...
        <div class="w-1/5 bg-white p-4 rounded-lg shadow-md flex flex-col">
            ...
            <div class="bg-blue-500 text-white p-4 rounded-lg shadow-md text-center border border-transparent hover:ring-4 hover:ring-gray-300 focus-within:ring-4 focus-within:ring-gray-300"
