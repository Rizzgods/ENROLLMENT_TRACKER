<div class="px-4 sm:px-6 lg:px-8">
    ...
    <div class="mt-6 flex flex-col sm:flex-row justify-center gap-4 sm:gap-8 sm:mt-8">
        <!-- Each item within the flex container -->
        <div class="flex flex-col justify-end rounded-lg bg-blue-50 px-4 py-6 sm:py-8 text-center w-full sm:w-64 h-32 sm:h-40">
            <?php
